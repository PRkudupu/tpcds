set role dsbench;
:EXPLAIN_ANALYZE
-- start query 98 in stream 2 using template query66.tpl and seed 1547959099
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'RUPEKSA' || ',' || 'GERMA' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 38085 and 38085+28800 
 	and sm_carrier in ('RUPEKSA','GERMA')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
