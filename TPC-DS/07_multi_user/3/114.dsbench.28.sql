set role dsbench;
:EXPLAIN_ANALYZE
-- start query 14 in stream 2 using template query28.tpl and seed 346658473
select  *
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 56 and 56+10 
             or ss_coupon_amt between 4634 and 4634+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 100 and 100+10
          or ss_coupon_amt between 2041 and 2041+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 38 and 38+10
          or ss_coupon_amt between 5180 and 5180+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 106 and 106+10
          or ss_coupon_amt between 1575 and 1575+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 105 and 105+10
          or ss_coupon_amt between 14478 and 14478+1000
